  ...
  return (
    <main className="min-h-screen bg-[#0a0f0d] text-white overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 pb-20">
        ...
        {/* CTA Banner */}
        <div className="bg-white/[0.03] backdrop-blur-xl border border-emerald-500/20 rounded-3xl p-8 mb-8 text-center">
          ...
          <a
            ...
            className="inline-block px-8 py-3 bg-gradient-to-r from-emerald-500 to-amber-500 text-white font-semibold rounded-xl hover:opacity-90 transition-all shadow-lg shadow-emerald-500/20"
          >
            Conhecer o Kit →
          </a>
          <p className="text-white/25 text-xs mt-4">Ferramentas gratuitas por Claudio Tools</p>
        </div>
